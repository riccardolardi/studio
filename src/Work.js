    ...
    <section id="work" className={classes} data-index={index}>
      ...
      <article className="with-image image-right">
        <a href="/work/sommernachts-ball" alt="" onClick={onProjectClicked.bind(this, 0)}>
          ...
          <div className="image">
            <LazyImage width={1024} height={956} src={imgs[0]} alt="" />
          </div>
        </a>
      </article>
      <article className="with-image image-left">
        <a href="/work/stephanwalter" alt="" onClick={onProjectClicked.bind(this, 1)}>
          ...
          <div className="image">
            <LazyImage width={1024} height={956} src={imgs[1]} alt="" />
          </div>
        </a>
      </article>
      <article className="with-image image-right">
        <a href="/work/ioc" alt="" onClick={onProjectClicked.bind(this, 2)}>
          ...
          <div className="image">
            <LazyImage width={1024} height={1010} src={imgs[2]} alt="" />
          </div>
        </a>
      </article>
      <article className="with-image image-left">
        <a href="/work/mplus" alt="" onClick={onProjectClicked.bind(this, 3)}>
          ...
          <div className="image">
            <LazyImage width={1024} height={1010} src={imgs[3]} alt="" />
          </div>
        </a>
      </article>
      <article className="with-image image-right">
        <a href="/work/hyundai" alt="Hyundai Olympic Pavilion" onClick={onProjectClicked.bind(this, 4)}>
          ...
          <div className="image">
            <LazyImage width={1200} height={675} src={imgs[4]} alt="" />
          </div>
        </a>
      </article>
      <article className="with-image image-left">
        <a href="/work/hanselgretel" alt="Hansel & Gretel" onClick={onProjectClicked.bind(this, 5)}>
          ...
          <div className="image">
            <LazyImage width={1200} height={675} src={imgs[5]} alt="" />
          </div>
        </a>
      </article>
      <article className="with-image image-right">
        <a href="/work/boston" alt="Harvard Square Theatre Facade" onClick={onProjectClicked.bind(this, 6)}>
          ...
          <div className="image">
            <LazyImage width={1200} height={675} src={imgs[6]} alt="" />
          </div>
        </a>
      </article>
      <article className="with-image image-left">
        <a href="/work/maersk" alt="Maersk Visitor Centre" onClick={onProjectClicked.bind(this, 7)}>
          ...
          <div className="image">
            <LazyImage width={1980} height={1320} src={imgs[7]} alt="" />
          </div>
        </a>
      </article>
    </section>
