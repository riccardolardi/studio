  ...
  return (
    <section id="project" className={classes}>
        ...
        <div className="images">
          <LazyImage src={require('./img/gmz/gmz1.jpg')} width="1148" height="636" alt="Sommernachts-Ball Mac" />
          <LazyImage src={require('./img/gmz/gmz2.png')} width="350" height="709" alt="Sommernachts-Ball iPhone" />
          <LazyImage src={require('./img/gmz/gmz3.png')} width="537" height="834" alt="Sommernachts-Ball iPad" />
        </div>
      </article>}
        ...
        <div className="images">
          <LazyImage src={require('./img/gmz/gmz1.jpg')} alt="Sommernachts-Ball Mac" />
