<script>
  ...
  $: if ($isInsta && fill) blockRef.style.height = `${window.innerHeight}px`;
  $: if ($isInsta && fill75) blockRef.style.height = `${window.innerHeight * 0.75}px`;
  $: if ($isInsta && fill50) blockRef.style.height = `${window.innerHeight * 0.5}px`;
</script>
